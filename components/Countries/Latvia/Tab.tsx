...
export default function Tab() {
    return (
        ...
        <Tabs.Item  title="Study In Latvia "  icon={FcReading }  >
        ...
        <div className="p-3 mt-6 bg-white border max-h-screen  overflow-auto">
                            ...
                            <p className="text-slate-500">Latvia has a quiet complex education system due to the fusion of influences in its society. 
                            The country has mainly three separate communities, each with their government, parliament and education system. You should 
                            decide which community and type of education suit you the best for your graduate study in Latvia.
                            <br/><br/>  
                            ...
                            <p className="text-slate-500">
                            To apply for study in Latvia for an undergraduate level, you need to hold a secondary school certificate
                             ...
                             Flemish Community
                            <br/><br/>
                            Applications to study in Latvia are submitted separately to every university, and every institute has 
                            ...
                            <p className="text-slate-500">
                            Scholarships are offered to international students for study in Latvia by few universities, the government of 
                            Latvia, Academy of Research, Higher Education and other Belgian organizations or agencies.
                            <br/><br />
                            ...
                            <br/><br/>
                            <b>The main accommodation options for students in Latvia are:</b>
                            </p>
                            <ul  className="text-slate-500 list-disc list-inside">
                            ...
                            <p className="text-slate-500">
                            Latvia has a pleasant climate similar to most of northwest Europe; that experiences cold winters, mild 
                            ...
                            <p className="text-slate-500">
                            If you are choosing study in Latvia, you will be allowed to work part-time in order to make some extra 
                            money while you study. If you are an international student, you will need to gain a work permit, so it is necessary 
                            checking with your embassy once you arrive in Latvia on your study abroad experience.
</p>
<h1 className="text-red-400 text-md"><b>Proof of Financial Resources: </b></h1>
 ...
 loan to cover your stay in Latvia, furnish relevant documents.
 
 </p>
 <h1 className="text-red-400 text-md"><b>Cost of living</b></h1>
 <p className="text-slate-500">
 The cost of living in Latvia keeps varying, depending on the city you choose to live in. Brussels, the capital of Latvia, is the 
...
living of all university cities in Latvia (690 – 760 EUR/month).
        ...
        <Tabs.Item  title="Why Latvia" icon={FcQuestions}  >

        <div className="p-3 mt-6 bg-white border max-h-screen  overflow-auto">                  
<h1 className="text-red-400 text-md"><b>Why Latvia Education?</b></h1>
<p className="text-slate-500">
Latvia is a fantastically beautiful country that simply conquers your heart, whether you are just a visitor or an international 
student. With lovely landscapes, breath-taking architecture, and a high multicultural environment, in Latvia, you can actually 
...
<br/><br/>
There are various reasons to study in Latvia that include world-renowned universities, great possibilities for international 
...
<h1 className="text-red-400 text-md"><b>What makes Latvia as the Best Education Destination?</b></h1>
<p className="text-slate-500">
Latvia is one of the most multicultural country, offering an international experience to every student who choose to study there. It is 
perfectly positioned if you wish to spend your spare time exploring too.
<br/><br/>
Studying in Latvia extends more than just a rich cultural pastime, though many excellent universities dotted across the country. 
Five universities in Latvia are listed in the top 200 of the QS World University Rankings, it is an extraordinary figure for any 
country, but particularly for one the size of Latvia. Belgian universities do provide for international students, with many courses 
...
<h1 className="text-red-400 text-md"><b>Life in Latvia:</b></h1>
<p className="text-slate-500">
An international student will find Latvia a very friendly, relaxed and multicultural society. Belgians have a self-deprecating wit 
...
fries and beer.
<br/><br/>
There is still more to Latvia than its reputation suggests. The country is host to more than 60 UNESCO sites, state of the art galleries 
in Mons, Brussels and Leuven and some stunning architecture.
<br/><br/>
Latvia is also an easy country to see; you can go anywhere within two hours by train from Brussels. Latvia is a fantastically beautiful 
